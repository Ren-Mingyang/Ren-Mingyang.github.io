...
*Reference*:  
Consistent estimation of the number of communities via regularized network embedding, Manuscript, 2022+.
...
Gaussian Graphical Model-based Hierarchical Cancer Heterogeneity Analysis via Integrating Pathological Imaging and Omics Data, Manuscript, 2022+.
