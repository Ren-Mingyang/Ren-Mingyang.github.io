...
## Publications  
- Li, C., Ma, H., & **Ren, M.**\* (2026+).  Local transfer learning for Gaussian graphical model-based heterogeneity analysis. *Bioinformatics*, In press. [[Codes](https://github.com/Ren-Mingyang/LtransHeteroGGM)]
- Li, X., Zhang, S., **Ren, M.** \*, & Zhang, Q. \* (2026+). Integrative learning of linear non-Gaussian directed acyclic graphs with application on multi-source gene regulatory network analysis. *Annals of Applied Statistics*, In press. [[Codes](https://github.com/Ren-Mingyang/IntegrativeDAG)]
