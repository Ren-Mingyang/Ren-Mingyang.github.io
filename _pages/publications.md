...
## Publications  
- Li, X., Zhang, S., **Ren, M.** *, & Zhang, Q. * (2025+). Integrative learning of linear non-Gaussian directed acyclic graphs with application on multi-source gene regulatory network analysis. In press. [[Codes](https://github.com/Ren-Mingyang/IntegrativeDAG)]
